init 5 python:
    addEvent(
        Event(
            ...
            eventlabel="monika_submod_remove_gf_and_breakup",
            category=['monika'],
...
label monika_submod_remove_gf_and_breakup:
    ...
    m 3eud "Anyways, just let me remove them real quick!"
    ...
    $ mas_lockEVL("monika_submod_remove_gf_and_breakup", "EVE")
